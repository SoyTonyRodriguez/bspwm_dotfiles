...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  colorizer = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/colorizer",
    url = "https://github.com/lilydjwg/colorizer"
  },
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  moonfly = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/moonfly",
  ...
  ["nvim-jdtls"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/nvim-jdtls",
  ...
  ["nvim-treesitter"] = {
    config = { "\27LJ\2\n8\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\29plugin_Config.treesitter\frequire\0" },
    loaded = true,
  ...
  tagbar = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["vCoolor.vim"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/vCoolor.vim",
    url = "https://github.com/KabbAmine/vCoolor.vim"
  },
  ["vim-illuminate"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/vim-illuminate",
    url = "https://github.com/rrethy/vim-illuminate"
  },
  ["vim-multiple-cursors"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/vim-multiple-cursors",
...
try_loadstring("\27LJ\2\n8\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\29plugin_Config.treesitter\frequire\0", "config", "nvim-treesitter")
