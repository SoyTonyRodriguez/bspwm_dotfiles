...
MENU="$(rofi -sep "|" -dmenu -i -p 'Select' -location 3 -columns 4 -xoffset -10 -yoffset 35 -width 50 -hide-scrollbar -line-padding 4 -padding 20 -lines 3 <<< "♥ deep-purple-dark|♥ grey-dark|♥ personal")"
...
case "$MENU" in
	...
	*personal) $SDIR/colors-dark.sh -fondo;;
esac
